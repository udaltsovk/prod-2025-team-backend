...
pub struct ScheduleRequest {
    ...
    pub send_at: ::prost_types::Timestamp,
}
...
pub mod notification_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn schedule(
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("notification.Notification", "Schedule"));
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/notification.Notification/Schedule" => {
                    ...
                    struct ScheduleSvc<T: Notification>(pub Arc<T>);
                    impl<
                        T: Notification,
                    ...
                    for ScheduleSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Notification>::schedule(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
